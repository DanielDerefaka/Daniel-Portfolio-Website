        ...
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card_img_hover">
            <div
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cusor-ponter"
            >
              <img
                src={github}
                alt={github}
    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          real-world examples of my work. Each project is briefly descrbed with
